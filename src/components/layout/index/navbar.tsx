...
export default function Navbar() {
  const links: string[] = ["Home", "Login", "Registro"]; // para manejarlo de manera mas sencilla de editarlo
  ...
  return (
    <div className="w-full h-12 flex justify-center items-center gap-10">
      ...
      <ul
        ...
        onMouseLeave={() => setVisible(false)} // si se sale del nav lo detecte de nuevo como null
      >
        {visible && (
          <span
